...
int ct_cp_set_prop_uint32(ct_connection_properties_t* props,
                          const ct_connection_property_enum_t prop_enum, const uint32_t val) {
...
int ct_cp_set_prop_uint64(ct_connection_properties_t* props,
                          const ct_connection_property_enum_t prop_enum, const uint64_t val) {
    if (props->list[prop_enum].read_only) {
        log_warn("Attempt to set read-only property: %s", props->list[prop_enum].name);
        return -EINVAL;
    }
...
int ct_cp_set_prop_bool(ct_connection_properties_t* props,
                        const ct_connection_property_enum_t prop_enum, const bool val) {
    if (props->list[prop_enum].read_only) {
        log_warn("Attempt to set read-only property: %s", props->list[prop_enum].name);
        return -EINVAL;
    }
...
int ct_cp_set_prop_enum(ct_connection_properties_t* props,
                        const ct_connection_property_enum_t prop_enum, const int val) {
    if (props->list[prop_enum].read_only) {
        log_warn("Attempt to set read-only property: %s", props->list[prop_enum].name);
        return -EINVAL;
    }
...
uint64_t ct_connection_properties_get_singular_transmission_msg_max_len(
...
uint32_t
ct_connection_properties_get_user_timeout_value_ms(ct_connection_properties_t* conn_props) {
    if (!conn_props) {
...
void ct_connection_properties_set_recv_checksum_len(ct_connection_properties_t* conn_props,
                                                    uint32_t recv_checksum_len) {
    if (!conn_props) {
...
void ct_connection_properties_set_conn_priority(ct_connection_properties_t* conn_props,
                                                uint32_t conn_priority) {
    if (!conn_props) {
...
void ct_connection_properties_set_keep_alive_timeout(ct_connection_properties_t* conn_props,
...
void ct_connection_properties_set_conn_scheduler(ct_connection_properties_t* conn_props,
                                                 ct_connection_scheduler_enum_t conn_scheduler) {
    if (!conn_props) {
...
void ct_connection_properties_set_conn_capacity_profile(
    ct_connection_properties_t* conn_props, ct_capacity_profile_enum_t conn_capacity_profile) {
    if (!conn_props) {
...
void ct_connection_properties_set_multipath_policy(ct_connection_properties_t* conn_props,
                                                   ct_multipath_policy_enum_t multipath_policy) {
    if (!conn_props) {
...
void ct_connection_properties_set_min_send_rate(ct_connection_properties_t* conn_props,
                                                uint64_t min_send_rate) {
    if (!conn_props) {
...
void ct_connection_properties_set_min_recv_rate(ct_connection_properties_t* conn_props,
                                                uint64_t min_recv_rate) {
    if (!conn_props) {
...
void ct_connection_properties_set_max_send_rate(ct_connection_properties_t* conn_props,
                                                uint64_t max_send_rate) {
    if (!conn_props) {
...
void ct_connection_properties_set_max_recv_rate(ct_connection_properties_t* conn_props,
                                                uint64_t max_recv_rate) {
    if (!conn_props) {
...
void ct_connection_properties_set_group_conn_limit(ct_connection_properties_t* conn_props,
                                                   uint64_t group_conn_limit) {
    if (!conn_props) {
...
void ct_connection_properties_set_isolate_session(ct_connection_properties_t* conn_props,
                                                  bool isolate_session) {
    if (!conn_props) {
...
void ct_connection_properties_set_user_timeout_value_ms(ct_connection_properties_t* conn_props,
                                                        uint32_t user_timeout_value_ms) {
    if (!conn_props) {
...
void ct_connection_properties_set_user_timeout_enabled(ct_connection_properties_t* conn_props,
                                                       bool user_timeout_enabled) {
    if (!conn_props) {
