 ...
 * connection group. This is useful for managing QUIC streams or other multiplexed
 * connections that share a transport session.
 *
 ...
 * @note Returns NULL if connection is NULL, has no group, or if memory allocation fails
