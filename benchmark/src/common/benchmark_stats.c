...
char* get_json_stats(transfer_mode_t mode, const transfer_stats_t* large_file_stats,
    ...
    result = asprintf(&json_str,
                      ...
                      "},"
                      "\"multi_streaming\": %s}",
                      implementation, large_handshake_ms, large_transfer_ms,
                      large_file_stats->bytes_received, large_throughput, small_handshake_ms,
                      small_transfer_ms, small_file_stats->bytes_received, small_throughput,
                      multi_streaming_str);
